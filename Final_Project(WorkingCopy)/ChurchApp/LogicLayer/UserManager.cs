...
namespace LogicLayer
{
    public class UserManager : IUserManager
    {
        ...
        /// <summary>
        /// retrieves a user id from eamil
        /// </summary>
        /// <param name="email"></param>
        /// <returns></returns>
        public int RetrieveUserIDFromEmail(string email)
        {
            try
            {
                return _userAccessor.getUserByEmail(email).PersonID;
            }
            catch (Exception ex)
            {
        ...
        /// <summary>
        /// adds a newly registered user
        /// </summary>
        /// <param name="user"></param>
        /// <param name="password"></param>
        /// <returns></returns>
        public int AddNewlyRegisteredUser(User user, string password)
        {
            var passwordHash = hashPassword(password);
            try
            {
                return _userAccessor.InsertNewlyRegisteredUser(user, passwordHash);
            }
            catch (Exception ex)
            {
