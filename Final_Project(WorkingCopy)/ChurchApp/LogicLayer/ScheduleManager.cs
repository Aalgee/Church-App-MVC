...
namespace LogicLayer
{
    public class ScheduleManager : IScheduleManager
    {
        ...
        /// <summary>
        /// Retrieves a schedule by schedule ID
        /// </summary>
        /// <param name="scheduleID"></param>
        /// <returns></returns>
        public PersonScheduleVM RetrieveScheduleByID(int scheduleID)
        {
            try
            {
                return _scheduleAccessor.SelectScheduleByScheduleID(scheduleID);
            }
            catch (Exception ex)
            {
