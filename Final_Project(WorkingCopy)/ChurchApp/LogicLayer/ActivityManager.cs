...
namespace LogicLayer
{
    public class ActivityManager : IActivityManager
    {
        ...
        /// <returns></returns>
        public bool ActivateActivity(int activityID)
        {
            try
            {
                return 1 == _activityAccessor.DeactivateReactivateActivity(activityID, true);
            }
            catch (Exception ex)
            {

                throw new ApplicationException("Activity not Activated", ex);
            }
        }
        ...
        public bool DeactivateActivity(int activityID)
        {
            try
            {
                return 1 == _activityAccessor.DeactivateReactivateActivity(activityID, false);
            }
            catch (Exception ex)
            {
        ...
        public ActivityVM RetrieveActivityByID(int activityID)
        {
            try
            {
                return _activityAccessor.SelectActivityByActivityID(activityID);
            }
            catch (Exception ex)
            {
                throw new ApplicationException("Activity not found!", ex);
        ...
        public List<ActivityVM> RetrieveAllActivitySchedulesByActive(bool active = true)
        {
            List<ActivityVM> activities = null;
            try
            {
                activities = _activityAccessor.SelectAllActivitySchedulesByActive(active);
            }
            catch (Exception ex)
            {
                throw new ApplicationException("Activity not found!", ex);
