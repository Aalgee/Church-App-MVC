...
print ' ' print '*** Creating sp_insert_newly_registered_person'
GO
CREATE PROCEDURE [sp_insert_newly_registered_person]
(
...
print ' ' print '*** Creating sp_update_candidate_votes'
GO
CREATE PROCEDURE [sp_update_candidate_votes]
(
	@CandidateID  	[int],
...
print '' print '*** Creating sp_delete_candidate'
GO
CREATE PROCEDURE [sp_delete_candidate]
(
	@CandidateID [int]
)
AS
...
print ' ' print '*** Creating Delegate Table'
GO
CREATE TABLE [dbo].[Delegate](
	[DelegateID]			[int]	IDENTITY(1000000,1)		NOT NULL,
	[FirstName]				[nvarchar](100)					NOT NULL,
	[LastName]				[nvarchar](100)					NOT NULL,
	[Pin]					[nvarchar](100)	UNIQUE 			NOT NULL,
	[HasVotedForGrants]		[bit]	DEFAULT 0 				NOT NULL,
	[HasVotedForElections]	[bit]	DEFAULT 0			NOT NULL,
	[Active]				[bit]	DEFAULT 1				NOT NULL,
	CONSTRAINT [pk_DelegateID] PRIMARY KEY([DelegateID] ASC)
)
GO

print '' print '*** Creating Sample Delegate Records'
GO
...
print ' ' print '*** Creating sp_insert_delegate'
GO
CREATE PROCEDURE [sp_insert_delegate]
(
...
BEGIN
	INSERT INTO [dbo].[Delegate]
		([FirstName],[LastName],[Pin])
	VALUES
		(@FirstName, @LastName,CONCAT(@LastName, FLOOR(RAND()*(9999-1000+1))+1000))
	SELECT SCOPE_IDENTITY()
END
GO

print ' ' print '*** Creating sp_select_delegates_by_active'
GO
CREATE PROCEDURE [sp_select_delegates_by_active]
(
	@Active  [bit]
)	
AS
...
print ' ' print '*** Creating sp_select_delegate_by_id'
GO
CREATE PROCEDURE [sp_select_delegate_by_id]
(
	@DelegateID  [int]
)	
AS
...
print ' ' print '*** Creating sp_select_delegates_by_id'
GO
CREATE PROCEDURE [sp_select_delegate_by_pin]
(
	@Pin  [nvarchar] (100)
)	
AS
...
print ' ' print '*** Creating sp_update_delegate'
GO
CREATE PROCEDURE [sp_update_delegate]
(
	@DelegateID  				[int]		,
	
	@OldFirstName				[nvarchar](100)	,
	@OldLastName				[nvarchar](100)	,
	@OldHasVotedForGrants		[bit]			,
	@OldHasVotedForElections	[bit]			,
	@OldActive					[bit]			,
	
	@NewFirstName				[nvarchar](100)	,
	@NewLastName				[nvarchar](100)	,
	@NewHasVotedForGrants		[bit]			,
	@NewHasVotedForElections	[bit]			,
	@NewActive					[bit]			
)	
AS
BEGIN
	UPDATE 	[dbo].[Delegate]
	   SET 	FirstName 				= 	@NewFirstName,
			...
			HasVotedForGrants		=	@NewHasVotedForGrants,
			HasVotedForElections	=	@NewHasVotedForElections,
			Active					=	@NewActive
	 WHERE	DelegateID				=	@DelegateID
	   AND	FirstName 				= 	@OldFirstName
	   AND	LastName				=	@OldLastName
	   AND  HasVotedForGrants		=   @OldHasVotedForGrants
	   AND  HasVotedForElections	=   @OldHasVotedForElections
	   AND	Active					=	@OldActive
	RETURN	@@ROWCOUNT
END
GO

print '' print '*** Creating sp_update_deligate_pin'
GO
CREATE PROCEDURE [sp_update_delegate_pin]
(
	@DelegateID [int],
	@Pin	[nvarchar] (100)
)
...
print '' print '*** Creating sp_deactivate_delegate'
GO
CREATE PROCEDURE [sp_deactivate_delegate]
(
	@DelegateID [int]
)
AS
...
print '' print '*** Creating sp_activate_delegate'
GO
CREATE PROCEDURE [sp_activate_delegate]
(
	@DelegateID [int]
)
AS
...
CREATE TABLE [dbo].[CompletedVote](
	...
	CONSTRAINT [fk_CompletedVote_Delegate_DelegateID] FOREIGN KEY ([DelegateID])
		REFERENCES [Person]([PersonID]),
...
INSERT INTO [dbo].[CompletedVote]
	([DelegateID],[ElectionID],[HasVoted])
	VALUES
	(1000000,1000000,1),
	(1000001,1000000,0),
	(1000002,1000001,1),
...
BEGIN
	SELECT
		...
		,[FirstName]			
		,[LastName]		
	FROM [CompletedVote] JOIN [Delegate] ON [Delegate].[DelegateID] = [CompletedVote].[DelegateID]
...
BEGIN
	UPDATE 	[dbo].[CompletedVote]
	   SET 	DelegateID 		= 	@NewDelegateID,
			ElectionID		=	@NewElectionID,
			HasVoted		=	@NewHasVoted
			
	 WHERE	CompletedVoteID	=	@CompletedVoteID
	   AND	DelegateID 		= 	@OldDelegateID
	   AND	ElectionID		=	@OldElectionID
...
INSERT INTO [dbo].[Grant]
	...
	('TestGrant4',0,'The fourth test grant',4000),
	('TestGrant5',0,'The fifth test grant',5000),
	('TestGrant6',0,'The sixth test grant',6000),
	('TestGrant7',0,'The seventh test grant',7000),
	('TestGrant8',0,'The eighth test grant',8000),
	('TestGrant9',0,'The ninth test grant',9000)
GO
...
print ' ' print '*** Creating sp_select_all_grants'
GO
CREATE PROCEDURE [sp_select_all_grants_by_active]
(
	@Active [bit]
)
AS
...
print ' ' print '*** Creating sp_update_grant_points_by_id'
GO
CREATE PROCEDURE [sp_update_grant_points_by_id]
(
	@GrantID	  		[int],
	@Points				[int]
)	
...
print '' print '*** Creating sp_reactivate_grant'
GO
CREATE PROCEDURE [sp_reactivate_grant]
(
	@GrantID [int]
)
AS
...
print '' print '*** Creating sp_select_person_by_id'
GO
CREATE PROCEDURE [sp_select_person_by_id]
(
	@PersonID	[int]
)
AS
...
print '' print '*** Creating sp_select_groups_with_discription_by_person_id'
GO
CREATE PROCEDURE [sp_select_groups_with_discription_by_person_id]
(
	@PersonID				[int]
)
AS
BEGIN
	SELECT [PersonGroup].[GroupID]
	, [Description]
	FROM [dbo].[PersonGroup] 
	JOIN [dbo].[Group] ON [Group].[GroupID] = [PersonGroup].[GroupID]
	WHERE [PersonID] = @PersonID
	AND [IsApproved] = 1
END
GO
...
print '' print '*** Creating sp_select_schedule_by_id'
GO
CREATE PROCEDURE [sp_select_schedule_by_id]
(
	@ScheduleID [int]
)
AS
...
print '' print '*** Creating sp_select_activities_by_schedule_type'
GO
...
BEGIN
	...
	,[End]
	FROM [Activity] JOIN [Schedule] ON [Activity].[ActivityID] = [Schedule].[ActivityID]
	WHERE [Activity].[Active] = @Active
	AND [ActivitySchedule] = 1
	AND [Start] > CURRENT_TIMESTAMP
END
GO

print '' print '*** Creating sp_select_activity_by_id'
GO
CREATE PROCEDURE [sp_select_activity_by_id]
(
	@ActivityID [int]
)
AS
...
print '' print '*** Creating sp_deactivate_activity'
GO
CREATE PROCEDURE [sp_deactivate_reactivate_activity]
(
	@ActivityID [int],
	@Active		[bit]
)
...
print '' print '*** Creating sp_retrieve_all_groups'
GO
CREATE PROCEDURE [sp_retrieve_all_groups]
AS
BEGIN
	SELECT
	[GroupID]
...
print '' print '*** Creating sp_insert_group'
GO
...
print '' print '*** Creating sp_delete_group'
GO
...
print '' print '*** Creating sp_select_group_by_id'
GO
CREATE PROCEDURE [sp_select_group_by_id]
(
	@GroupID	[nvarchar] (100)
)
AS
...
print '' print '*** Creating sp_delete_person_groups_by_group_id'
GO
CREATE PROCEDURE [sp_delete_person_groups_by_group_id]
(
	@GroupID	[nvarchar] (100)
)
AS
...
print '' print '*** Creating sp_delete_group_activities_by_group_id'
GO
CREATE PROCEDURE [sp_delete_group_activities_by_group_id]
(
	@GroupID	[nvarchar] (100)
)
AS
